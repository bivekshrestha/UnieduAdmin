                ...
                <ValidationObserver ref="observer" v-slot="{ validate, reset }">
                  <form>
                    <v-row>
                      ...
                      <v-col cols="12">
                        <ValidationProvider v-slot="{ errors }" name="Cities" rules="required">
                          <v-text-field
                            :error-messages="errors"
                            label="Cities"
                            v-model="form.cities"
                      ...
                      <v-col cols="12">
                        <ValidationProvider v-slot="{ errors }" name="Website URL" rules="required">
                          <v-text-field
                            :error-messages="errors"
                            label="Website URL"
                            v-model="form.url"
                      ...
                      <v-col cols="12" v-else>
                        ...
                        <v-img v-if="form.image" width="50%" :src="setSrc(form.image.path)"></v-img>
                      </v-col>
                    </v-row>
                  </form>
                </ValidationObserver>
      ...
      <v-col cols="12" md="12" lg="12">
        ...
        >
          ...
          <template v-slot:item.action="{ item }">
            ...
            <v-btn
              icon
              :to="{name: 'institutions-id', params: {id: item.id}}"
              color="red accent-3"
            >
  ...
  export default {
    data() {
      return {
        ...
        headers: [
          ...
          {text: 'Route', align: 'start', value: 'route'},
    ...
    methods: {
      ...
      async uploadFile() {
        ...
        data.append('institutions', this.fileToUpload);
